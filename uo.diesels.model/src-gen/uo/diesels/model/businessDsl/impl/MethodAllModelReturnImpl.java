 ...
 * </p>
 * <ul>
 *   <li>{@link uo.diesels.model.businessDsl.impl.MethodAllModelReturnImpl#getReturnType <em>Return Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodAllModelReturnImpl extends FinderUserMethodImpl implements MethodAllModelReturn
{
  /**
  ...
  {
    return BusinessDslPackage.Literals.METHOD_ALL_MODEL_RETURN;
  }
    ...
    if (returnType != null && returnType.eIsProxy())
    {
      ...
      if (returnType != oldReturnType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BusinessDslPackage.METHOD_ALL_MODEL_RETURN__RETURN_TYPE, oldReturnType, returnType));
      }
    }
    return returnType;
  }
  ...
  public void setReturnType(AllModelType newReturnType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BusinessDslPackage.METHOD_ALL_MODEL_RETURN__RETURN_TYPE, oldReturnType, returnType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BusinessDslPackage.METHOD_ALL_MODEL_RETURN__RETURN_TYPE:
