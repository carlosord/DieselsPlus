    ...
    CharSequence _xblockexpression = null;
    {
      ...
      }
      {
        ...
        for(final ModelVariableDefinition v_1 : _attributes_1) {
          ...
          String _typeFor_1 = _instance_5.getTypeFor(_variableType_1);
          ...
          if ((ModelUtils.isReflexiveRelation(l_1.getRelations()) && (!Objects.equal(ModelUtils.containsEntity(l_1.getRelations(), e), null)))) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_contains_9) {
                ...
                String _get_28 = _get_27[1];
                String _name_18 = r1_1.getName();
                boolean _isOptional_6 = r2_1.isOptional();
                String _format_11 = String.format(_get_28, _name_18, Boolean.valueOf(_isOptional_6));
                _builder.append(_format_11, "");
                _builder.newLineIfNotEmpty();
                _builder.append("private ");
                String _className = l_1.getClassName();
                _builder.append(_className, "");
                _builder.append(" ");
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("private Set<");
                String _className_1 = l_1.getClassName();
            ...
            }
            {
              ...
              if (_contains_10) {
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("private ");
                String _className_2 = l_1.getClassName();
                ...
                String _name_23 = r2_1.getName();
                String _format_14 = String.format(_get_34, _name_23);
                _builder.append(_format_14, "");
                _builder.newLineIfNotEmpty();
                _builder.append("private Set<");
                String _className_3 = l_1.getClassName();
              ...
              if (_notEquals_1) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_contains_11) {
                    ...
                    String _get_36 = _get_35[1];
                    String _name_25 = thisRel_1.getName();
                    boolean _isOptional_8 = otherRel_1.isOptional();
                    String _format_15 = String.format(_get_36, _name_25, Boolean.valueOf(_isOptional_8));
                    ...
                    String _name_27 = thisRel_1.getName();
                    String _format_16 = String.format(_get_38, _name_27);
        ...
        for(final ModelVariableDefinition v : allIds) {
          {
            ...
            if ((_variableTypeClass instanceof SimpleLink)) {
              ...
              String _typeFor = _instance.getTypeFor(_variableType_1);
              _builder.append(_typeFor, "");
              _builder.append(" ");
              String _variableName_1 = v.getVariableName();
              _builder.append(_variableName_1, "");
      ...
      for(final ModelVariableDefinition v : _attributes) {
        {
          if (((!(v instanceof ModelTypeCollectionVariableClass)) && (!(v instanceof SimpleTypeCollectionVariableClass)))) {
            ...
            String _typeFor_2 = _instance_2.getTypeFor(_variableType_2);
            _builder.append(_typeFor_2, "");
            _builder.append(" ");
          ...
          if ((ModelUtils.isReflexiveRelation(l.getRelations()) && (!Objects.equal(ModelUtils.containsEntity(l.getRelations(), e), null)))) {
            ...
            }
            {
              ...
              if (_contains_1) {
                ...
                _builder.append(className, "");
                _builder.append(" get");
                String _name_14 = r2.getName();
                String _upperFirst_5 = StringUtils.toUpperFirst(_name_14);
                _builder.append(_upperFirst_5, "");
                _builder.append("() {");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("return this.");
                String _name_15 = r2.getName();
                _builder.append(_name_15, "\t");
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("}");
                ...
                _builder.append(className, "");
                _builder.append("> _get");
                String _name_16 = r2.getName();
                String _upperFirst_6 = StringUtils.toUpperFirst(_name_16);
                _builder.append(_upperFirst_6, "");
                _builder.append("() {");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("return this.");
                String _name_17 = r2.getName();
                _builder.append(_name_17, "\t");
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("}");
                ...
                _builder.append(className, "");
                _builder.append("> get");
                String _name_18 = r2.getName();
                String _upperFirst_7 = StringUtils.toUpperFirst(_name_18);
                _builder.append(_upperFirst_7, "");
                _builder.append("() {");
                _builder.newLineIfNotEmpty();
                _builder.append("\t");
                _builder.append("return new HashSet<>(");
                String _name_19 = r2.getName();
                _builder.append(_name_19, "\t");
                _builder.append(");");
                _builder.newLineIfNotEmpty();
                _builder.append("}");
