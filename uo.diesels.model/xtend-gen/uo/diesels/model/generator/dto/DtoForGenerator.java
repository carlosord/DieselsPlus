...
public class DtoForGenerator {
  ...
  public DtoForGenerator(final Resource resource, final IFileSystemAccess fsa, final String project) {
  ...
  public void compile() {
    ...
    for (final DtoFor dto : _filter) {
      {
        DtoForClass d = new DtoForClass(dto);
        StringBuilder sb = new StringBuilder();
        CharSequence _compileText = this.compileText(d);
        sb.append(_compileText);
        String _name = d.getName();
        String entityPath = String.format(PathConstants.DTO_PATH, this.project, _name);
  ...
  public CharSequence compileText(final DtoForClass d) {
  ...
  public CharSequence createImportDeclarations(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
    {
      String _remplaceSlashToDot = StringUtils.remplaceSlashToDot(this.project);
  ...
  public CharSequence createClassDeclaration(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public CharSequence createEmptyConstructor(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public CharSequence createAttributeDeclarations(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
    {
      List<DtoVariableDefinition> _attributes = d.getAttributes();
  ...
  public CharSequence createGettersSetters(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
    {
      List<DtoVariableDefinition> _attributes = d.getAttributes();
      for(final DtoVariableDefinition a : _attributes) {
  ...
  public CharSequence createHashCodeEquals(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public CharSequence createToString(final DtoForClass d) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("@Override");
    _builder.newLine();
