...
public class NewBusinessDslFile extends Wizard implements INewWizard {

    private IStructuredSelection selection;
    private NewBusinessDslFilePage newBusinessDslFilePage;

    public NewBusinessDslFile() {
        setWindowTitle("Diesels DSL File");
    }

    @Override
    public void addPages() {
        newBusinessDslFilePage = new NewBusinessDslFilePage(selection);
        addPage(newBusinessDslFilePage);
    }

    @Override
    public boolean performFinish() {
        final IFile file = newBusinessDslFilePage.createNewFile();
