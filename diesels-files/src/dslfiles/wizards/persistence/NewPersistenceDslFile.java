...
public class NewPersistenceDslFile extends Wizard implements INewWizard {

    private IStructuredSelection selection;
    private NewPersistenceDslFilePage newPersistenceDslFilePage;

    public NewPersistenceDslFile() {
        setWindowTitle("Diesels DSL File");
    }

    @Override
    public void addPages() {
        newPersistenceDslFilePage = new NewPersistenceDslFilePage(selection);
        addPage(newPersistenceDslFilePage);
    }

    @Override
    public boolean performFinish() {
        final IFile file = newPersistenceDslFilePage.createNewFile();
